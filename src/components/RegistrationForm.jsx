...
const RegistrationForm = ({ submitFormHandler }) => {
  return (
    <form onSubmit={submitFormHandler} id='signup'>
      ...
      <input name='password' type='password' id='password' style={infoInput}></input>
      <br></br>
      <label style={info}>Confirm Password</label>
      <input name='confirm_password' type='password' id='confirm_password' style={infoInput}></input>
      <br></br>
      <button id='submit' style={submitButton}>Submit</button>
    </form>
  );
};
